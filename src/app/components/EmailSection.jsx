...
const EmailSection = () => {
  ...
  return (
    <section
      id="contact"
      className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative pt-32 md:pt-24"
    >
      ...
      <div className="z-10 relative">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/PetiCodes">
            <Image src={GithubIcon} alt="Mohammed Petiwala Github" />
          </Link>
          <Link href="https://www.linkedin.com/in/mohdpeti">
            <Image src={LinkedinIcon} alt="Mohammed Petiwala LinkedIn" />
          </Link>
        </div>
      </div>
      <div>
