...
// Japanese character mappings for "Let's Connect"
const japaneseMap = {
  'L': 'ル', 'e': 'え', 't': 'て', "'": "'", 's': 'す', ' ': ' ', 'C': 'カ', 'o': 'お', 'n': 'ん', 'c': 'ち'
};

const ConnectAnimation = forwardRef(({ 
  className = "",
  speed = 100 
}, ref) => {
  ...
  const targetText = "Let's Connect";
...
ConnectAnimation.displayName = 'ConnectAnimation';
